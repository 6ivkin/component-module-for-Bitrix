...
class proxima_invoices_module extends CModule
{
    /**
     * invoices_module constructor.
     */
    public function __construct()
    {
        $this->MODULE_ID = 'proxima.invoices.module';
        $this->MODULE_NAME = '[Proxima] Таблица оплаченных счетов';
        $this->MODULE_DESCRIPTION = 'Таблица оплаченных счетов';
        $arModuleVersion = [];
